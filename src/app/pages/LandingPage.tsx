      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
            A professional platform where students can get expert help with
            their assignments and projects, while skilled writers earn from
            their expertise.
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">
              Access to verified and approved writers with proven expertise in
              various subjects.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">
              All writers are vetted and rated by students to ensure
              high-quality work.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">
              Real-time project tracking and updates throughout the assignment
              lifecycle.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">
              From STEM to humanities, find writers specialized in your subject
              area.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Students post projects, writers apply, and the best match is
                selected.
              </p>
            </div>
